...
import org.androidtown.multimemoapp.VoiceRecorder.OnStateChangedListener;
...
public class VoiceRecordingActivity extends AppCompatActivity implements OnStateChangedListener {
	...
	public void init(Bundle icycle)
	{
        ...
        mWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "multiMemoApp:MediGalaxy");
