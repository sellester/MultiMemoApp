package org.androidtown.multimemoapp.db;
...
import org.androidtown.multimemoapp.BasicInfo;
...
public class MemoDatabase {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context) {	// 데이터베이스 이름과 데이터베이스 버전 정보를 이용해 상위 클래스 생성자 호출
