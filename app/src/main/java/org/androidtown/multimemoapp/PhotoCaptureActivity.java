    ...
    class CameraPictureCallback implements Camera.PictureCallback {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
            ...
            try {
    			...
    			FileOutputStream outstream = new FileOutputStream(BasicInfo.FOLDER_PHOTO + photoName);  // 비트맵 이미지를 파일로 쓰기 위한
    			resultBitmap.compress(CompressFormat.PNG, 100, outstream);                             // 스트림 객체 생성
            ...
            showParentActivity();   // 메모 입력화면으로 전환
        }
	}
